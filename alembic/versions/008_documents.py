...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "storage_backend", sa.String(32), nullable=False, default="filesystem"
        ),
        ...
        sa.CheckConstraint(
            "kind IN ('letter', 'statement', 'form', 'identification', 'receipt', 'other')",
    ...
    op.create_index(
        op.f("uq_document_tag"), "document_tag", ["document_id", "label"], unique=True
    )
