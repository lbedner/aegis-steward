...
class TransactionsPanelState(ft.Container):  # type: ignore[misc]
    ...
    if TYPE_CHECKING:  # the real definitions live on the mixins / panel
        ...
        async def _load_more(self, *args: Any, **kwargs: Any) -> Any: ...
        ...
        def _refresh(self, *args: Any, **kwargs: Any) -> Any: ...
        def _remove_tag(self, *args: Any, **kwargs: Any) -> Any: ...
        def _set_subtitle(self, *args: Any, **kwargs: Any) -> Any: ...
        def _update_selection_label(self, *args: Any, **kwargs: Any) -> Any: ...
