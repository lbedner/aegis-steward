...
from app.services.finance.domains.ledger.institutions import (  # noqa: F401
    get_or_create_institution,
    institution_usage,
    last_institution_used,
    list_institutions,
    set_account_institution,
    update_institution,
)
...
async def update_account(
    ...
    *,
    ...
    if reference is not None:
        # "" clears it: the number was wrong, or was never theirs.
        account.reference = reference or None
